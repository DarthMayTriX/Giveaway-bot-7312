...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const userr = new EmbedBuilder()
     ...
     .setDescription("**Your Report Have Been Submitted!**\n Check Your DM\n<:lock:1010213107651584101> DM locked? Then check this [link](https://www.youtube.com/watch?v=QSP40zHcJwU)")
     .setColor('#2F3136')

    const dm = new EmbedBuilder()
     .setAuthor({ name: `${interaction.user.username}`, iconURL: interaction.user.displayAvatarURL({ dynamic: true}) })
     .setTitle('Little Notice for you') 
     .setDescription("By submitting the report, you're agreeing to our privacy policy and our terms of conditions DarthMayTriX. All your reports and your user data will be recorded and stored until the casefile is done. Spam reports will result in a blacklist or permanent ban on all our products or services. Please use the report system wisely. Have a nice day and thanks for your report.")
     .setColor('#2F3136')
    .setFooter({ text: 'Code by DarthMayTrix', iconURL: 'https://i.imgur.com/krlhpIo.png' })

    const row = new ActionRowBuilder()
       .addComponents(
    	new ButtonBuilder()
    .setLabel("Read DISCORD COMMUNITY GUIDELINES")
